...
data.start_time = datenum([fileData{2}{1} fileData{3}{1} fileData{4}{1} fileData{5}{1}], 'yyyymmddHH');
data.height = fileData{17};
data.height(abs(data.height - 999999) < 1e-2) = NaN;
...
data.wind_dir = fileData{15};
data.wind_dir(abs(data.wind_dir - 999999) < 1e-2) = NaN;
data.wind_speed = fileData{16};
data.wind_speed(abs(data.wind_speed - 999999) < 1e-2) = NaN;
